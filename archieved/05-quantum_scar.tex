...
整个实验过程中施加 \SI{3}{\micro\tesla} 的偏置磁场。
...
先前的理论工作~\cite{yuan2022quantum}预测，当使用 $\mathbb{Z}_2$ 有序奈尔态作为研究非时序关联函数和 Holevo 信息时空演化的初态时，可能会观察到持续的信息回流和量子混沌的不寻常破坏。这些结果表明了研究动力学受限多体系统中量子信息加扰独特动力学的新途径。
