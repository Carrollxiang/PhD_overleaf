...
\textbf{b} 和 \textbf{c}, 
    ...
    颜色条对应于 Holevo 信息 $\mathbb{X}_{j}(t)$ 的值。数值模拟利用里德堡哈密顿量 $\hat{H}_\text{R}$ 并根据实验系统的精确表征考虑了各种实验缺陷（见方法和第~\ref{ch6new:sec:error-char} 节）。
  }
